...
int main() {
    try {
        ...
        std::ofstream ofs1("video1.hevc", std::ofstream::out + std::ofstream::binary);
        std::ofstream ofs2("video2.hevc", std::ofstream::out + std::ofstream::binary);
        {
            encode::Encoder encoder1(config, ofs1);
            encode::Encoder encoder2(config, ofs2);
